...
export default function AccountSigninPage() {
  ...
  const handleContinue = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // TODO: implement login/session (NextAuth or JWT cookie) then redirect accordingly
      router.push("/"); // change to your preferred page
    } catch (err) {
      console.error(err);
      ...
      >
        <div style={{ display: "flex", justifyContent: "center" }}>
          ...
          >
            ...
            >
              We&apos;re excited to have you join our member. Fill in detail for
              your account
            </p>
                ...
                <div style={{ width: "720px", maxWidth: "100%" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      cursor:
                        isSubmitting || !email ? "not-allowed" : "pointer",
